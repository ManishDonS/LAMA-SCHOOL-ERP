-- Comprehensive Student Schema Migration
-- This migration extends the student system with detailed tracking capabilities
...
CREATE TABLE IF NOT EXISTS academic_records (
    ...
    term VARCHAR(50) NOT NULL, -- Term 1, Term 2, Final
...
CREATE TABLE IF NOT EXISTS health_records (
    id BIGSERIAL PRIMARY KEY,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    record_type VARCHAR(50) NOT NULL, -- medical_condition, allergy, medication, vaccination, checkup
...
CREATE TABLE IF NOT EXISTS behavioral_records (
    id BIGSERIAL PRIMARY KEY,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    record_type VARCHAR(50) NOT NULL, -- positive, negative, neutral
    category VARCHAR(100), -- discipline, achievement, participation, conduct
    title VARCHAR(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS student_documents (
    id BIGSERIAL PRIMARY KEY,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    document_type VARCHAR(100) NOT NULL, -- certificate, report, id_proof, photo, etc.
    title VARCHAR(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS parent_communications (
    id BIGSERIAL PRIMARY KEY,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    communication_type VARCHAR(50) NOT NULL, -- meeting, call, email, sms, message
    subject VARCHAR(200),
    message TEXT,
    communication_date TIMESTAMP NOT NULL,
    initiated_by VARCHAR(50), -- parent, teacher, admin
    teacher_id BIGINT,
    parent_id BIGINT,
...
CREATE TABLE IF NOT EXISTS student_activities (
    id BIGSERIAL PRIMARY KEY,
    student_id BIGINT NOT NULL REFERENCES students(id) ON DELETE CASCADE,
    activity_type VARCHAR(100) NOT NULL, -- enrollment, grade_update, attendance, payment, document_upload, etc.
    title VARCHAR(200) NOT NULL,
    description TEXT,
